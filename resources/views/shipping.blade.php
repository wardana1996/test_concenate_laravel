...
<div class="container-fluid mt-5">
    <center><h1 style="font-family: Courier, monospace;">Shipping App (cek ongkos kirim kamu disini)</h1></center>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control provinsi-asal" name="province_origin">
                            ...
                            @foreach ($provinceOrigin as $province => $value)
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control provinsi-tujuan" name="province_destination">
                                ...
                                @foreach ($provinceDestination as $province => $value)
                                    <option value="{{ $province  }}">{{ $value }}</option>
                                @endforeach
                            </select>
                        </div>
...
<script>
    $(document).ready(function(){
        $(".provinsi-asal , .kota-asal, .provinsi-tujuan, .kota-tujuan")
            .select2({
        ...
        $('.btn-check').click(function (e) {
            ...
            isProcessing = true;
            $.ajax({
                url: "{{ route('shipping.checkongkir') }}",
                data: {
                    _token:              token,
